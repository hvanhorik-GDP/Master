...
#include "MidTerm_2018_Callback.h"
#include "Common/globalstuff.h"

#include "Physics/cPhysicsTilter.h"
#include "Physics/ObjectCreator.h"
...
int MidTerm_2018_test(gamelibrary::GameLibrary& gameLib)
{
	...
	glfwSetKeyCallback(window, MidTerm_2018_key_callback);
	// Set the mouse button callback
	glfwSetMouseButtonCallback(window, MidTerm_2018_mouse_button_callback);
...
//	mapLoaded["pyramid_a"] = NULL;
	...
	mapLoaded["surface_output_02"] = NULL;
	mapLoaded["surface_output_03"] = NULL;
	mapLoaded["surface_output_04"] = NULL;
...
//	mapLoaded["Terrain_XYZ_n"] = NULL;
	...
	//CloneObject(1, "surface_output_01", objectsLib.GetNode());
	//CloneObject(1, "surface_output_02", objectsLib.GetNode());
	//CloneObject(1, "surface_output_03", objectsLib.GetNode());
	//CloneObject(1, "surface_output_04", objectsLib.GetNode());
