...
class cObjectManager_Video :
	public iObjectManager
{
private:
	cObjectManager_Video();
	virtual ~cObjectManager_Video();
	...
	friend std::ostream& operator<<(std::ostream& stream, const cObjectManager_Video& val);
