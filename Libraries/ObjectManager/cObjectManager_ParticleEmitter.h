...
class cObjectManager_ParticleEmitter :
	public iObjectManager
{
private:
	cObjectManager_ParticleEmitter();
	virtual ~cObjectManager_ParticleEmitter();
	...
	friend std::ostream& operator<<(std::ostream& stream, const cObjectManager_ParticleEmitter& val);
