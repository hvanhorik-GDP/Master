...
class cAudio_Geometry_FMOD
{
public:


	cAudio_Geometry_FMOD();
	virtual ~cAudio_Geometry_FMOD();

	void Release();

	friend std::ostream& operator<<(std::ostream& stream, const cAudio_Geometry_FMOD& val);
