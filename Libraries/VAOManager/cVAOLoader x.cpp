...
bool cVAOLoader::LoadModelIntoVAO(
...
{
	// Write some code to copy the infomation from cMesh& theModel
	//  to the sModelDrawInfo& drawInfo...

	drawInfo.numberOfVertices = (unsigned int)theModel.m_vecVertices.size();
	...
	for (unsigned int index = 0; index != drawInfo.numberOfVertices; index++)
	{
		...
		drawInfo.pVertices[index].x = theModel.m_vecVertices[index].x;
		drawInfo.pVertices[index].y = theModel.m_vecVertices[index].y;
		drawInfo.pVertices[index].z = theModel.m_vecVertices[index].z;
		...
		drawInfo.pVertices[index].nx = theModel.m_vecVertices[index].nx;
		drawInfo.pVertices[index].ny = theModel.m_vecVertices[index].ny;
		drawInfo.pVertices[index].nz = theModel.m_vecVertices[index].nz;
	...
	drawInfo.numberOfTriangles = (unsigned int)theModel.m_vecTriangles.size();
	drawInfo.numberOfIndices = (unsigned int)theModel.m_vecTriangles.size() * 3;
	...
	{
		drawInfo.pIndices[indexIndex + 0] = (unsigned int)theModel.m_vecTriangles[indexTri].vert_index_1;
		drawInfo.pIndices[indexIndex + 1] = (unsigned int)theModel.m_vecTriangles[indexTri].vert_index_2;
		drawInfo.pIndices[indexIndex + 2] = (unsigned int)theModel.m_vecTriangles[indexTri].vert_index_3;
	}


	drawInfo.meshName = friendlyName;
...
bool cVAOLoader::FindDrawInfoByModelName(
		std::string filename,
		sModelDrawInfo &drawInfo) 
{
