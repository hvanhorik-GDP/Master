...
void CalcAABBsForMeshModel(cItem_Model& theMesh)
{
	...
	for (std::vector<cItem_Model::sPlyTriangle>::iterator itTri = theMesh.m_vecTriangles.begin();
		 itTri != theMesh.m_vecTriangles.end(); itTri++)
	{
		glm::vec3 v1;
		v1.x = theMesh.m_vecVertices[itTri->vert_index_1].x;
		v1.y = theMesh.m_vecVertices[itTri->vert_index_1].y;
		v1.z = theMesh.m_vecVertices[itTri->vert_index_1].z;
		glm::vec3 v2;
		v2.x = theMesh.m_vecVertices[itTri->vert_index_2].x;
		v2.y = theMesh.m_vecVertices[itTri->vert_index_2].y;
		v2.z = theMesh.m_vecVertices[itTri->vert_index_2].z;
		glm::vec3 v3;
		v3.x = theMesh.m_vecVertices[itTri->vert_index_3].x;
		v3.y = theMesh.m_vecVertices[itTri->vert_index_3].y;
		v3.z = theMesh.m_vecVertices[itTri->vert_index_3].z;
