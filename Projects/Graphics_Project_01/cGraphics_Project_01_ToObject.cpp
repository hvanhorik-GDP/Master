...
cGraphics_Project_01_ToObject::cGraphics_Project_01_ToObject()
{
	cMessageManager().Register(gGraphicsObjectName, this);
}

void cGraphics_Project_01_ToObject::NextVisable()
{
	if (m_CurrentObject)
...
void cGraphics_Project_01_ToObject::NextInvisable()
{
	if (m_CurrentObject)
		m_CurrentObject->SetVisable(m_lastWasVisable);
...
void cGraphics_Project_01_ToObject::Rotate(int plane, float value)
{
	if (!m_CurrentObject)
		return;
...
void cGraphics_Project_01_ToObject::AdjustColour(int color, float value)
{
	if (!m_CurrentObject)
		return;
	std::string name = m_CurrentObject->GetName();
...
void cGraphics_Project_01_ToObject::Scale(float value)
{
	if (!m_CurrentObject)
		return;
	std::string name = m_CurrentObject->GetName();
...
void cGraphics_Project_01_ToObject::Move(int plane, float value)
{
	if (!m_CurrentObject)
		return;
	std::string name = m_CurrentObject->GetName();
...
void cGraphics_Project_01_ToObject::Light(int type, float value)
{
	if (!m_CurrentObject)
		return;
	std::string name = m_CurrentObject->GetName();
...
void cGraphics_Project_01_ToObject::SetDebug(bool value)
{
	bool m_debug = false;
	if (!m_CurrentObject)
		return;
...
void cGraphics_Project_01_ToObject::SetWireFrame(bool value)
{
	bool m_debug = false;
	if (!m_CurrentObject)
		return;
...
void cGraphics_Project_01_ToObject::Focus()
{
	if (!m_CurrentObject)
		return;
...
const std::string& cGraphics_Project_01_ToObject::GetMyUID() const
{
	return gGraphicsObjectName;
}

void cGraphics_Project_01_ToObject::TargetModels()
{
...
void cGraphics_Project_01_ToObject::TargetLights()
{
	// Restore previous object
	if (m_CurrentObject)
		m_CurrentObject->SetVisable(m_lastWasVisable);
...
void cGraphics_Project_01_ToObject::TargetGroups()
{
	// Restore previous object
	if (m_CurrentObject)
		m_CurrentObject->SetVisable(m_lastWasVisable);
...
void cGraphics_Project_01_ToObject::TargetWorld()
{
	// Restore previous object
	if (m_CurrentObject)
		m_CurrentObject->SetVisable(m_lastWasVisable);
