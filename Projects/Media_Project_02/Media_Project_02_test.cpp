#include "Media_Project_02_test.h"
...
int Media_Project_02_test(gamelibrary::GameLibrary& gameLib)
{
	...
	glfwSetKeyCallback(window, Media_Project_02_key_callback);
	// Set the mouse button callback
	glfwSetMouseButtonCallback(window, Media_Project_02_mouse_button_callback);
