...
cMedia_Project_02_Tilter::cMedia_Project_02_Tilter()
	: m_trackObject(NULL)
{
	cMessageManager().Register(gTilterName, this);
}

const std::string& cMedia_Project_02_Tilter::GetMyUID() const
{
	return gTilterName;
}

void cMedia_Project_02_Tilter::track()
{
...
void cMedia_Project_02_Tilter::tiltPlane(int plane, float value)
{
	if (m_trackObject)
	{
		...
		// Media_Project_02Tilter and example of using iMessageInterface
